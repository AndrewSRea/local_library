...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we for a reponse "success"
        self.assertEqual(response.status_code, 200)
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_birth_initially_set_to_expected_date(self):
        login = self.client.get(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'), {'first_name': 'Christian Name', 'last_name': 'Surname'})
        self.assertEqual(response.status_code, 302)
